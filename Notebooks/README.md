...
For example, if the base release daemonset is already running within the namespace and we want to update to the next update we'd run the following command:
